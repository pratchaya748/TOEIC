...
$sql = "Update tbl_member set  member_name = '$member_name' , member_password = '$member_password' , member_mail = '$member_mail', member_card_id = '$member_card_id' , member_department = '$depcode'  where member_username like '$id'";
