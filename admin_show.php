        ...
        <div class="card bg-light text-dark text-left p-3" style="text-align: center; border-radius: 25px;">
            ...
            <div class="card-header bg-light text-dark">
                <div class="form-inline justify-content-between">
                   <!-- ค้นหา -->
                    ...
                    <form action="pdf_academic.php" method="post" class="form-inline ">
                        ...
                        <?php echo "<a class='btn btn-outline-danger' target='_blank' href='pdf_academic.php?year=".$year."&search=".$search."'> Export PDF </a>";?>
                    </form> 
                </div>
                ...
                <div class="form-inline justify-content-between">
                    ...
                    <form action="import.php" class="form-inline ">
